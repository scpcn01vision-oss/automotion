...
| id | 中文名 | 场景标签 | 使用场景描述 |
|---|---|---|---|
| OscilloscopeStream | 示波流 | 举证 | 描述量持续波动变化的，有数字进行匹配更好 |
| UnitDotSwarmRegroup | 点阵重组 | 举证 | 描述几个量的对比关系的，有数字进行匹配更好 |
...
| ScrambleDecode | 乱码归位 | 钩子,宣告 | 标题展示或揭示 |
...
| GradientWordSweep | 光扫词面 | 宣告 | 句内单词突出展示 |
...
| ParticleSandFill | 沙粒填形 | 举证 | 数据可视化：多个值的柱状图 |
