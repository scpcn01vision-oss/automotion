// === 可调参数 ===
// DURATION: 130（总帧数，可调；弹性段随 DURATION 等比缩放）
// 色彩: 走纸墨 G 色板（src/_fixtures/Fixtures.tsx）——文字 G.ink / 背景 G.bg / 强调 G.accent
// 功能: 承接,转折
// props: subjectImage（目标高清卡素材，长廊 9 卡取 live-layout）
// === 时间特性 ===
// 刚性（不可压缩）: 无（全程弹性）
...
export interface WhipBrakeRealProps {
  subjectImage?: string;
}

export const WhipBrakeReal: React.FC<WhipBrakeRealProps> = ({
