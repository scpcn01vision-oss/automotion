...
// 功能: 举证
// props: rows（景 A 内容）、detail（景 B 内容，detail 揭示）
// === 时间特性 ===
// 策略: 弹刚 ShotTime（整段弹性）
// 刚性（不可压缩）: 无
...
// circle-match-iris（match-cut / iris-reveal）——
// 0-30 景 A 静态展示；30-75 圆心虹膜展开（clip-path circle 22px→2100px，inOut cubic）揭示景 B；
// 45-100 进度弧 sweep 至 78%、detail 同步；100-140 真静止。
// 注：本文件头注释曾因历史编码问题损坏（'?'），2026-08-14 精修时按源码重写。
