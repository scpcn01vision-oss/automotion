    ...
    <AbsoluteFill style={{ background: G.ink, justifyContent: 'center', alignItems: 'center' }}>
      ...
      <div
        style={{
          ...
          borderRadius: '50%',
          background:
            'radial-gradient(closest-side, rgba(211,146,60,0.6), rgba(242,201,138,0.25) 55%, transparent 78%)',
          filter: 'blur(38px)',
            ...
            {filling && p < 1 && (
              <span
                ...
                style={{
                  ...
                  textShadow: '0 0 22px rgba(255,255,255,0.9), 0 0 55px rgba(232,184,120,0.8)',
                }}
              >
                Supercharged
              </span>
